...
public class BiryaniRecpies extends Activity{
	ListView listView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.biryanirecpies);
	//	mInterstitial = new InterstitialAd(this);
//		mInterstitial.setAdUnitId(getResources().getString(R.string.ad_unit_id));
//		mInterstitial.loadAd(new AdRequest.Builder().build());
//		mInterstitial.setAdListener(new ToastAdListener(BiryaniRecpies.this) {
//			@Override
...
//		});
		...
		listView.setAdapter(new MyAdapter(BiryaniRecpies.this));
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent i=new Intent(BiryaniRecpies.this,BiryaniRecpiesExpAct.class);
	...
	public class MyAdapter extends BaseAdapter{
		...
		public int getCount() {
			// TODO Auto-generated method stub
			return UniversalClass.biryaniimages.length;
		}
		@Override
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			imageView.setBackgroundResource(UniversalClass.biryaniimages[position]);
			TextView tv= vi.findViewById(R.id.text);
			tv.setText(UniversalClass.biryanitypes[position]);
			return vi;
		}
	}
