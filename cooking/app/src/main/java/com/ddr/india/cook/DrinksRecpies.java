...
public class DrinksRecpies extends Activity{
	ListView listView;
//	InterstitialAd mInterstitial;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.drinksrecpies);
		
//		mInterstitial = new InterstitialAd(this);
//		mInterstitial.setAdUnitId(getResources().getString(R.string.ad_unit_id));
//		mInterstitial.loadAd(new AdRequest.Builder().build());
//		mInterstitial.setAdListener(new ToastAdListener(DrinksRecpies.this) {
//			@Override
...
//		});
		...
		listView.setAdapter(new MyAdapter(DrinksRecpies.this));
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent i=new Intent(DrinksRecpies.this,DrinksRecpiesExpAct.class);
	...
	public class MyAdapter extends BaseAdapter{
		...
		public int getCount() {
			// TODO Auto-generated method stub
			return UniversalClass.drinksimages.length;
		}
		@Override
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			imageView.setBackgroundResource(UniversalClass.drinksimages[position]);
			TextView tv= vi.findViewById(R.id.text);
			tv.setText(UniversalClass.drinkstypes[position]);
			return vi;
		}
	}
