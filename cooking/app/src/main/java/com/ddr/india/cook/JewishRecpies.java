...
public class JewishRecpies extends Activity{
	ListView listView;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jeweishrecpies);
		listView= findViewById(R.id.africanrecpieslist);
		listView.setAdapter(new MyAdapter(JewishRecpies.this));
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent i=new Intent(JewishRecpies.this,JewishRecpiesExpAct.class);
	...
	public class MyAdapter extends BaseAdapter{
		...
		public int getCount() {
			// TODO Auto-generated method stub
			return UniversalClass.jewishimages.length;
		}
		@Override
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			imageView.setBackgroundResource(UniversalClass.jewishimages[position]);
			TextView tv= vi.findViewById(R.id.text);
			tv.setText(UniversalClass.jewishetypes[position]);
			return vi;
		}
	}
