...
public class MexicRecpies extends Activity{
	ListView listView;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mexicanrecpies);
		listView= findViewById(R.id.africanrecpieslist);
		listView.setAdapter(new MyAdapter(MexicRecpies.this));
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent i=new Intent(MexicRecpies.this,mexicanRecpiesExpAct.class);
	...
	public class MyAdapter extends BaseAdapter{
		...
		public int getCount() {
			// TODO Auto-generated method stub
			return UniversalClass.mexicanimages.length;
		}
		@Override
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			imageView.setBackgroundResource(UniversalClass.mexicanimages[position]);
			TextView tv= vi.findViewById(R.id.text);
			tv.setText(UniversalClass.mexicantypes[position]);
			return vi;
		}
	}
