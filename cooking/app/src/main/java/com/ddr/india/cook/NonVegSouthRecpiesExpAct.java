...
public class NonVegSouthRecpiesExpAct extends Activity{
	int position;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.nonvegsouthrecpiesexpact);
...
//		mInterstitial.setAdListener(new ToastAdListener(NonVegSouthRecpiesExpAct.this) {
//			@Override
