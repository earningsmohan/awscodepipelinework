...
public class SaladRecpies extends Activity{
	ListView listView;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.saladrecpies);
		listView= findViewById(R.id.africanrecpieslist);
		listView.setAdapter(new MyAdapter(SaladRecpies.this));
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent i=new Intent(SaladRecpies.this,SaladRecpiesExpAct.class);
	...
	public class MyAdapter extends BaseAdapter{
		...
		public int getCount() {
			// TODO Auto-generated method stub
			return UniversalClass.saladsimages.length;
		}
		@Override
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			imageView.setBackgroundResource(UniversalClass.saladsimages[position]);
			TextView tv= vi.findViewById(R.id.text);
			tv.setText(UniversalClass.saladstypes[position]);
			return vi;
		}
	}
