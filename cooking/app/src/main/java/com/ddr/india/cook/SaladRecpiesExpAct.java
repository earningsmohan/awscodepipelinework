...
public class SaladRecpiesExpAct extends Activity{
	int position;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.saladsrecpiesexpact);
		...
		/*type14=(ScrollView)findViewById(R.id.type14);
		type15=(ScrollView)findViewById(R.id.type15);
		type16=(ScrollView)findViewById(R.id.type16);
		type17=(ScrollView)findViewById(R.id.type17);
		type18=(ScrollView)findViewById(R.id.type18);
		type19=(ScrollView)findViewById(R.id.type19);
		type20=(ScrollView)findViewById(R.id.type20);
		type21=(ScrollView)findViewById(R.id.type21);
		type22=(ScrollView)findViewById(R.id.type22);
		type23=(ScrollView)findViewById(R.id.type23);
		/*type24=(ScrollView)findViewById(R.id.type24);
		type25=(ScrollView)findViewById(R.id.type25);
		type26=(ScrollView)findViewById(R.id.type26);
		type27=(ScrollView)findViewById(R.id.type27);
		type28=(ScrollView)findViewById(R.id.type28);
		type29=(ScrollView)findViewById(R.id.type29);
		type30=(ScrollView)findViewById(R.id.type30);*/
