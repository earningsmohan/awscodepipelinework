...
public class ThaiRecpies extends Activity{
	ListView listView;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.thairecpies);
		listView= findViewById(R.id.africanrecpieslist);
		listView.setAdapter(new MyAdapter(ThaiRecpies.this));
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent i=new Intent(ThaiRecpies.this,ThaiRecpiesExpAct.class);
	...
	public class MyAdapter extends BaseAdapter{
		...
		public int getCount() {
			// TODO Auto-generated method stub
			return UniversalClass.thaiimages.length;
		}
		@Override
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			imageView.setBackgroundResource(UniversalClass.thaiimages[position]);
			TextView tv= vi.findViewById(R.id.text);
			tv.setText(UniversalClass.thaitypes[position]);
			return vi;
		}
	}
